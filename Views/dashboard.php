    ...
    <body>
        ...
        <!-- Main Content -->
            ...
            <ul class="nav nav-tabs nav-justified">
                <li class="nav-item">
                    <a class='nav-link' href="<?= HOST ?>admin/posts">BLOG POSTS</a>
                </li>
                <li class="nav-item">
                    <a class='nav-link' href="<?= HOST ?>admin/comments">COMMENTAIRES</a>
                </li>
                <li class="nav-item">
                    <?php if(in_array('Host', $role)): ?>
                    <a class='nav-link' href="<?= HOST ?>admin/users">UTILISATEURS</a>
                    <?php endif; ?>
                </li>
            </ul>
